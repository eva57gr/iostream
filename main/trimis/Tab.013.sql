...
SELECT
  ...
  NOZERO(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1190') THEN D.COL2 END)) AS COL5,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL3 END))/
  NOZERO(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL2 END)) AS COL5_1,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1190') THEN D.COL4 END))/
  NOZERO(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1190') THEN D.COL2 END)) AS COL6,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL4 END))/
  NOZERO(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL2 END)) AS COL6_1,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1190') THEN D.COL5 END)) AS COL7,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL5 END)) AS COL7_1,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1190') THEN D.COL3 END))+
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1190') THEN D.COL5 END)) AS COL8,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL3 END))+
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL5 END)) AS COL8_1,
  ...
  NVAL((CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1190') THEN D.COL5 END)))) AS COL9,
  SUM(NVAL((CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL4 END))+
  (NVAL((CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL4 END))/
  NOZERO((CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL3 END))*
  NVAL((CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1191') THEN D.COL5 END)))) AS COL9_1
FROM 
  VW_DATA_ALL D
