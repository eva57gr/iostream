DROP VIEW USER_BANCU.VW_KATALOG_85_EDU_2021;

CREATE OR REPLACE FORCE VIEW USER_BANCU.VW_Nr_2_2010
(CUIIO, CUIIO_VERS, DENUMIRE, EDIT_USER, STATUT, 
 ...
 TIP_INV, RENIM_PERS, ORGANE_COND, IDNO)
AS 
SELECT R.CUIIO,
           R.CUIIO_VERS,
           R.DENUMIRE,
      ...
      FROM (SELECT FC.CUIIO,
              ...
              FROM CIS2.FORM_CUIIO  FC
                   INNER JOIN (  SELECT CUIIO, MAX (CUIIO_VERS) CUIIO_VERS
                                  ...
                                  WHERE FORM IN (25) AND CUIIO_VERS <= 2010
                               GROUP BY CUIIO) BB
                       ON (    BB.CUIIO = FC.CUIIO
                           AND BB.CUIIO_VERS = FC.CUIIO_VERS)
             WHERE FC.FORM IN (25) AND FC.STATUT <> '3') FC
