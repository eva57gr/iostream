CREATE OR REPLACE FORCE VIEW USER_BANCU.VW_DATA_ALL_2022 
AS
SELECT 
DISTINCT CUIIO, 
SUM(COL1) AS COL1,
...
HAVING 
    (COALESCE(SUM(COL1),0) + COALESCE(SUM(COL2),0) + COALESCE(SUM(COL3),0) + COALESCE(SUM(COL4),0) +
     COALESCE(SUM(COL5),0) + COALESCE(SUM(COL6),0) + COALESCE(SUM(COL7),0) + COALESCE(SUM(COL8),0) +
     COALESCE(SUM(COL9),0) + COALESCE(SUM(COL10),0) + COALESCE(SUM(COL11),0) + COALESCE(SUM(COL12),0)) > 0