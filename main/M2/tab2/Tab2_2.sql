SELECT
                ...
                D.FORM,
                    CASE WHEN D.RIND IN ('CAEM') THEN
                     DECODE(C.NR_COL,'5',D.COL5,'6',D.COL6,'7',D.COL7,'8',D.COL8,'9',D.COL9,'10',D.COL10,'11',D.COL11,'12',D.COL12)
                     WHEN C.NR_COL IN('1','2','3','4') THEN
                     DECODE(C.NR_COL,'1',0,'2',TO_NUMBER(SUBSTR(D.CAEM2,2,5)),'3',D.COL3)
                END AS CAEM2,
