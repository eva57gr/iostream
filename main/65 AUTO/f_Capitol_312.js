...
//If in the variables to be assigned the autosum is zero, assign null or empty space.
var from = "";
...
function sumRind002() {
    ...
    rind002Col1.val(sumCol1.toFixed(1)); // Rounded to 1 decimal place
    rind002Col2.val(sumCol2); // Integer
...
function sumCapIII_Rind999() {
    ...
    // Calculate the sums
    rowIDs.forEach(function (row) {
        var col1Val = parseFloat($("#5_312_" + row.id + "_" + row.rind + "_1").val()) || 0.0; // Maybe can be || 0.0;  
        var col2Val = parseInt($("#5_312_" + row.id + "_" + row.rind + "_2").val()) || 0;
        sumCol1 += col1Val;
        sumCol2 += col2Val;
    });
    ...
    rind999Col1.val(sumCol1.toFixed(1)); // Rounded to 1 decimal place
    rind999Col2.val(sumCol2); // Integer
...
function calculateRow001() {
    ...
    rind001Col1.val(row001Col1.toFixed(1)); // Rounded to 1 decimal place
    rind001Col2.val(row001Col2); // Integer
...
function f_Capitol_312() {
    // Call the original logic (if any)
    // ...
