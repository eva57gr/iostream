...
--)
  ...
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND NOT IN '0000000' AND D.CAPITOL IN (1035) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL9)>0 THEN D.RIND END))) AS COL1, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND NOT IN '0000000' AND D.CAPITOL IN (1035) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL9)>0 AND C.PRGS IN (2,3,4,5) THEN D.RIND  END))) AS COL2,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND NOT IN '0000000' AND D.CAPITOL IN (1035) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL9)>0 AND C.PRGS IN (6,8,9)   THEN  D.RIND END))) AS COL3,
  
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND NOT IN '0000000' AND D.CAPITOL IN (1037) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL9)>0 THEN D.RIND END))) AS COL4, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND NOT IN '0000000' AND D.CAPITOL IN (1037) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL9)>0 AND C.PRGS IN (2,3,4,5) THEN D.RIND  END))) AS COL5,
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND NOT IN '0000000' AND D.CAPITOL IN (1037) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL9)>0 AND C.PRGS IN (6,8,9)   THEN  D.RIND END))) AS COL6
