...
NULL CAP1_3_COL11
 ...
 SELECT
  ...
  ROUND(SUM(CASE WHEN D.CAPITOL IN (1035) THEN D.COL7 ELSE 0 END),1) AS CAP1_2_COL10,
  ROUND(SUM(CASE WHEN D.CAPITOL IN (1035) THEN D.COL8 ELSE 0 END),1) AS CAP1_2_COL11,
  ROUND(SUM(CASE WHEN D.CAPITOL IN (1035) THEN D.COL9 ELSE 0 END),1) AS CAP1_2_COL12,
