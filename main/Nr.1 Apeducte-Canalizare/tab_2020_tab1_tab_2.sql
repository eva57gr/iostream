...
--  D.IDNO,
  ...
  D.COL1 tab_1_col_3,
  D.COL2 tab_1_col_7,
  D.COL3 tab_1_1_col_12,
  D.COL4 tab_1_1_col_13,
...
SELECT
  ...
  R.CFP, 
  D.RIND,
  ROUND(SUM(CASE WHEN D.CAPITOL IN (1034) THEN D.COL3 ELSE 0 END),1) AS COL1,
  ROUND(SUM(CASE WHEN D.CAPITOL IN (1034) THEN D.COL7 ELSE 0 END),1) AS COL2,
  NULL AS COL3,
  NULL AS COL4,
  NULL AS COL5,
  NULL AS COL6,
...
GROUP BY 
  ...
  NULL AS COL1,
  NULL AS COL2,
  ROUND(SUM(CASE WHEN D.CAPITOL IN (1035) THEN D.COL4 ELSE 0 END),1) AS COL3,
  ROUND(SUM(CASE WHEN D.CAPITOL IN (1035) THEN D.COL5 ELSE 0 END),1) AS COL4,
