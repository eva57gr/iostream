...
WHERE
  ...
  D.FORM IN (71) AND
  D.CAPITOL IN (1181,1182,1183,1184,1185,1186,1187,1195) AND
  (
...
SELECT 1181 AS CAPITOL1, 1181 AS CAPITOL2, '180' AS RIND1, '181' AS RIND2, 6 AS ORDINE, '1' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '<=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, '0' AS BOTH_COL, NULL AS CAEM2 FROM DUAL UNION
...
SELECT 1187 AS CAPITOL1, NULL AS CAPITOL2, '900' AS RIND1, NULL AS RIND2, 86 AS ORDINE, '1' AS NR_COLUMN1, NULL AS NR_COLUMN2, '>' AS CONDITIE1, NULL AS CONDITIE2, '0' AS RESULT1, '' AS RESULT2, '0' AS BOTH_COL, NULL AS CAEM2 FROM DUAL UNION
