...
SELECT
   ...
   '000000000000000' AS DECIMAL_POS,
    ...
    CASE WHEN  B.COL2 =  0 THEN NULL ELSE B.COL2 END COL2,
    CASE WHEN  B.COL3 =  0 THEN NULL ELSE B.COL3 END COL3,
    CASE WHEN  B.COL4 =  0 THEN NULL ELSE B.COL4 END COL4,
    CASE WHEN  B.COL5 =  0 THEN NULL ELSE B.COL5 END COL5,
    CASE WHEN  B.COL6 =  0 THEN NULL ELSE B.COL6 END COL6,
    CASE WHEN  B.COL7 =  0 THEN NULL ELSE B.COL7 END COL7,
    CASE WHEN  B.COL8 =  0 THEN NULL ELSE B.COL8 END COL8,
    CASE WHEN  B.COL9 =  0 THEN NULL ELSE B.COL9 END COL9,
    CASE WHEN  B.COL10 =  0 THEN NULL ELSE B.COL10 END COL10,
    CASE WHEN  B.COL11 =  0 THEN NULL ELSE B.COL11 END COL11,
    CASE WHEN  B.COL12 =  0 THEN NULL ELSE B.COL12 END COL12,
    CASE WHEN  B.COL13 =  0 THEN NULL ELSE B.COL13 END COL13,
    CASE WHEN  B.COL14 =  0 THEN NULL ELSE B.COL14 END COL14,
    CASE WHEN  B.COL15 =  0 THEN NULL ELSE B.COL15 END COL15 
