...
--  D.CUIIO,
  ...
  CASE 
    ...
    THEN
      MAX(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) THEN D.CAPITOL_DEN END)||' Rindul.'||MAX(TR.RIND1)||' ati selectat '||MAX(DECODE(NR_COLUMN1,'1','Da','2','Nu'))||' atunci Rindul.'||MAX(TR.RIND2)||' sa anuleze bifa'
  WHEN
      MAX(TR.CONDITIE1) IN ('=') AND MAX(TR.CONDITIE2) IN ('<>') AND MAX(TR.BOTH_COL) IN ('ROWS2') AND
      (SUM(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) AND TR.RIND1 IN (D.RIND) THEN NVAL(DECODE(NR_COLUMN1,'1',D.COL1,'2',D.COL2)) ELSE 0 END) = MAX(TR.RESULT1) AND
      SUM(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL2) AND TR.RIND2 LIKE ('%'||D.RIND||'%') AND LENGTH(D.RIND) > TR.RIND_LENGTH THEN NVAL(DECODE(NR_COLUMN2,'1',D.COL1,'2',D.COL2)) ELSE 0 END) <> MAX(TR.RESULT2)) 
    THEN
      MAX(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) THEN D.CAPITOL_DEN END)||' Rindul.'||MAX(TR.RIND1)||' ati selectat '||MAX(DECODE(NR_COLUMN1,'1','Da','2','Nu'))||' atunci unul din Rindrile.'||MAX(TR.RIND2)||' trebuie sa fie bifate'
  WHEN
  ...
  SUM(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL2) AND TR.RIND2 LIKE ('%'||D.RIND||'%') AND LENGTH(D.RIND) = TR.RIND_LENGTH THEN NVAL(D.COL1)+NVAL(D.COL2) ELSE 0 END) >= MAX(TR.RESULT2)) 
    THEN
      MAX(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) THEN D.CAPITOL_DEN END)||' Rindul.'||MAX(TR.RIND1)||' ati selectat '||MAX(DECODE(NR_COLUMN1,'1','Da','2','Nu'))||' atunci Rindul.'||MAX(TR.RIND2)||' se anuleaza bifa'
  WHEN
  ...
  SUM(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL2) AND TR.RIND2 LIKE ('%'||SUBSTR(D.CAEM2,0,1)||'%') THEN 1 ELSE 0 END) = MAX(TR.RESULT2)) 
    THEN
      MAX(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) THEN D.CAPITOL_DEN END)||'Ati introdus Rindul.'||MAX(TR.RIND1)||' care se completeaza doar de catre entita?ile cu genurile principale de activitate "Industrie" sau "Construc?ii"'
  WHEN
      MAX(TR.CONDITIE1) IN ('=') AND MAX(TR.CONDITIE2) IN ('<>') AND MAX(TR.BOTH_COL) IN ('1') AND
      (SUM(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) AND TR.RIND1 IN (D.RIND) THEN NVAL(DECODE(NR_COLUMN1,'1',D.COL1,'2',D.COL2)) ELSE 0 END) = MAX(TR.RESULT1) AND
  SUM(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL2) AND TR.RIND2 LIKE ('%'||D.RIND||'%') AND LENGTH(D.RIND) = TR.RIND_LENGTH THEN NVAL(D.COL1)+NVAL(D.COL2) ELSE 0 END) <> MAX(TR.RESULT2))
  ...
  SUM(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL2) AND TR.RIND2 LIKE ('%'||D.RIND||'%') THEN NVAL(DECODE(NR_COLUMN1,'1',D.COL1,'2',D.COL2)) ELSE 0 END) > MAX(TR.RESULT2)) 
    THEN
      MAX(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) THEN D.CAPITOL_DEN END)||'Nu ati introdus Rindul.'||MAX(TR.RIND2)||' care se completeaza doar de catre entita?ile cu genurile principale de activitate "Industrie" sau "Construc?ii"'
  WHEN
      MAX(TR.CONDITIE1) IN ('=') AND MAX(TR.CONDITIE2) IN ('<=') AND MAX(TR.BOTH_COL) IN ('1') AND
  ...
  SUM(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL2) AND TR.RIND2 LIKE ('%'||D.RIND||'%') AND LENGTH(D.RIND) = TR.RIND_LENGTH THEN NVAL(D.COL1)+NVAL(D.COL2) ELSE 0 END) <= MAX(TR.RESULT2)) 
    THEN
      MAX(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) THEN D.CAPITOL_DEN END)||' Rindul.'||MAX(TR.RIND1)||' ati selectat '||MAX(DECODE(NR_COLUMN1,'1','Da','2','Nu'))||' atunci Rindul.'||MAX(TR.RIND2)||' trebuie sa fie bifate'
  WHEN
      MAX(TR.CONDITIE1) IN ('=') AND MAX(TR.CONDITIE2) IN ('>') AND MAX(TR.BOTH_COL) IN ('ROWS2') AND
      (SUM(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) AND TR.RIND1 LIKE ('%'||D.RIND||'%') THEN NVAL(DECODE(NR_COLUMN1,'1',D.COL1,'2',D.COL2)) ELSE 0 END) = MAX(TR.RESULT1) AND
    ...
    THEN
      MAX(DISTINCT CASE WHEN D.CAPITOL IN (TR.CAPITOL1) THEN D.CAPITOL_DEN END)||' Rindul.'||MAX(TR.RIND2)||' ati bifat mai multe variante de raspuns'
...
WHERE
  ...
  (SELECT
    ...
    WHERE
      ...
      DD.RIND NOT IN ('CD')) IN (1)
 )D
CROSS JOIN
 (
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '1.1,1.2,1.3' AS RIND2, 1 AS ORDINE, '1' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '1.1,1.2,1.3' AS RIND2, 2 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '<>' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '2.1,2.2,2.3' AS RIND2, 3 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '3.1,3.2,3.3' AS RIND2, 4 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '4.1,4.2,4.3' AS RIND2, 5 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '5.1,5.2,5.3' AS RIND2, 6 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '6.1,6.2,6.3' AS RIND2, 7 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '7.1,7.2,7.3' AS RIND2, 8 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '8.01,8.02,8.3,8.04,8.05,8.06,8.07,8.08' AS RIND2, 9 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 3 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '10.1,10.2,10.3' AS RIND2, 10 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 3 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '11.1,11.2,11.3' AS RIND2, 11 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 3 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '12.1,12.2,12.3,12.4,12.5' AS RIND2, 12 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 3 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '13.1,13.2,13.3,13.4' AS RIND2, 13 AS ORDINE, '2' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, 'ROWS2' AS BOTH_COL, 3 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '8' AS RIND2, 14 AS ORDINE, '2' AS NR_COLUMN1, '1,2' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, '1' AS BOTH_COL, 1 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '9' AS RIND2, 15 AS ORDINE, '2' AS NR_COLUMN1, '1,2' AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, '1' AS BOTH_COL, 1 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '14' AS RIND1, 'C,F' AS RIND2, 16 AS ORDINE, '1' AS NR_COLUMN1, '1,2' AS NR_COLUMN2, '>' AS CONDITIE1, 'CAEM2' AS CONDITIE2, '0' AS RESULT1, '0' AS RESULT2, 'ROWS1' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, '15.1,15.2,15.3' AS RIND1, 'C,F' AS RIND2, 17 AS ORDINE, '1' AS NR_COLUMN1, '1,2' AS NR_COLUMN2, '>' AS CONDITIE1, 'CAEM2' AS CONDITIE2, '0' AS RESULT1, '0' AS RESULT2, 'ROWS1' AS BOTH_COL, 4 AS RIND_LENGTH FROM DUAL UNION
...
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, 'C,F' AS RIND1, '14' AS RIND2, 30 AS ORDINE, '1' AS NR_COLUMN1, '1' AS NR_COLUMN2, 'CAEM2' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, 'ROWS1' AS BOTH_COL, 2 AS RIND_LENGTH FROM DUAL UNION
SELECT 1197 AS CAPITOL1, 1197 AS CAPITOL2, 'C,F' AS RIND1, '15.1,15.2,15.3' AS RIND2, 31 AS ORDINE, '1' AS NR_COLUMN1, '1' AS NR_COLUMN2, 'CAEM2' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, 'ROWS1' AS BOTH_COL, 4 AS RIND_LENGTH FROM DUAL UNION
...
SELECT 1199 AS CAPITOL1, 1197 AS CAPITOL2, '1' AS RIND1, '1' AS RIND2, 43 AS ORDINE, '1' AS NR_COLUMN1, '1' AS NR_COLUMN2, '=' AS CONDITIE1, '<>' AS CONDITIE2, '1' AS RESULT1, '1' AS RESULT2, '1' AS BOTH_COL, 1 AS RIND_LENGTH FROM DUAL
