...
SELECT
  ...
  TR.RIND,
--  SUBSTR(A.CAEM2,1,1),
  COUNT(CASE WHEN A.RIND IN ('1.1') AND (TR.RIND LIKE '%'|| SUBSTR(A.CAEM2,1,1) ||'%' OR (BS.PERS_IT >= TR.PERS_INIT AND BS.PERS_IT <= TR.PERS_FINAL)) THEN A.CUIIO END) AS COL1,
  COUNT(CASE WHEN A.RIND IN ('1.2') AND (TR.RIND LIKE '%'|| SUBSTR(A.CAEM2,1,1) ||'%' OR (BS.PERS_IT >= TR.PERS_INIT AND BS.PERS_IT <= TR.PERS_FINAL)) THEN A.CUIIO END) AS COL2,
  COUNT(CASE WHEN A.RIND IN ('1.3') AND (TR.RIND LIKE '%'|| SUBSTR(A.CAEM2,1,1) ||'%' OR (BS.PERS_IT >= TR.PERS_INIT AND BS.PERS_IT <= TR.PERS_FINAL)) THEN A.CUIIO END) AS COL3
FROM
(SELECT
  D.ANUL,
  D.CUIIO,
