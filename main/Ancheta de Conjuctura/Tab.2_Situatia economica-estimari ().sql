...
SELECT
  ...
  CC.CS_CUATM AS RIND,
--  SUBSTR(A.CAEM2,1,1),
  SUM(CASE WHEN A.RIND IN ('2.1') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL1,
  SUM(CASE WHEN A.RIND IN ('2.2') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL2,
  SUM(CASE WHEN A.RIND IN ('2.3') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL3
FROM
(SELECT
  D.ANUL,
  D.CUIIO,
...
(SELECT
  ...
  A.CAEM2 AS RIND,
  SUM(CASE WHEN A.RIND IN ('2.1') AND C.FULL_CODE LIKE '%'||CC.CODUL||';%' THEN A.COL1 END) AS COL1,
  SUM(CASE WHEN A.RIND IN ('2.2') AND C.FULL_CODE LIKE '%'||CC.CODUL||';%' THEN A.COL1 END) AS COL2,
  SUM(CASE WHEN A.RIND IN ('2.3') AND C.FULL_CODE LIKE '%'||CC.CODUL||';%' THEN A.COL1 END) AS COL3
FROM
(SELECT
  D.ANUL,
  D.CUIIO,
