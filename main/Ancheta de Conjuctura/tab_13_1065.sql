...
WHERE
  ...
  (
    ...
    SELECT 1 AS NR_TABLE, 'CAEM2' AS TABLE_DENUMIRE, NULL AS PERS_INIT, NULL AS PERS_FINAL, 'G+H+I+J+L+M+N+R+S' AS RIND, 'Servicii (G+H+I+J+L+M+N+R+S)' AS RIND_DENUMIRE, '143.1' AS ORDINE FROM DUAL UNION
...
SELECT
  ...
  CC.CS_CUATM AS RIND,
--  SUBSTR(A.CAEM2,1,1),
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.1') AND A.COL1 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL1,
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.2') AND A.COL1 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL2,
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.3') AND A.COL1 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL3,
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.4') AND A.COL1 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL4,
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.5') AND A.COL1 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL5,
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.1') AND A.COL2 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL6,
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.2') AND A.COL2 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL7,
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.3') AND A.COL2 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL8,
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.4') AND A.COL2 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL9,
  COUNT(DISTINCT CASE WHEN A.RIND IN ('13.5') AND A.COL2 IN (1) AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.CUIIO END) AS COL10
FROM
(SELECT
  D.ANUL,
  D.CUIIO,
