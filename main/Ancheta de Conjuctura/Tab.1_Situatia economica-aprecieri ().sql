...
SELECT
  ...
  TR.RIND,
--  SUBSTR(A.CAEM2,1,1),
  SUM(CASE WHEN A.RIND IN ('7.1') AND (TR.RIND LIKE '%'|| SUBSTR(A.CAEM2,1,1) ||'%' OR (ROUND(BS.PERS_IT) >= TR.PERS_INIT AND ROUND(BS.PERS_IT) <= TR.PERS_FINAL)) THEN A.COL1 END) AS COL1,
  SUM(CASE WHEN A.RIND IN ('7.2') AND (TR.RIND LIKE '%'|| SUBSTR(A.CAEM2,1,1) ||'%' OR (ROUND(BS.PERS_IT) >= TR.PERS_INIT AND ROUND(BS.PERS_IT) <= TR.PERS_FINAL)) THEN A.COL1 END) AS COL2,
  SUM(CASE WHEN A.RIND IN ('7.3') AND (TR.RIND LIKE '%'|| SUBSTR(A.CAEM2,1,1) ||'%' OR (ROUND(BS.PERS_IT) >= TR.PERS_INIT AND ROUND(BS.PERS_IT) <= TR.PERS_FINAL)) THEN A.COL1 END) AS COL3
FROM
(SELECT
  D.ANUL,
  D.CUIIO,
...
WHERE
  ...
  D.RIND IN ('7.1','7.2','7.3')--AND D.CUIIO=40988116
) A LEFT JOIN
...
SELECT
  ...
  CC.CS_CUATM AS RIND,
--  SUBSTR(A.CAEM2,1,1),
  SUM(CASE WHEN A.RIND IN ('7.1') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL1,
  SUM(CASE WHEN A.RIND IN ('7.2') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL2,
  SUM(CASE WHEN A.RIND IN ('7.3') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL3
FROM
(SELECT
  D.ANUL,
  D.CUIIO,
...
(SELECT
  ...
  A.CAEM2 AS RIND,
  SUM(CASE WHEN A.RIND IN ('7.1') AND C.FULL_CODE LIKE '%'||CC.CODUL||';%' THEN A.COL1 END) AS COL1,
  SUM(CASE WHEN A.RIND IN ('7.2') AND C.FULL_CODE LIKE '%'||CC.CODUL||';%' THEN A.COL1 END) AS COL2,
  SUM(CASE WHEN A.RIND IN ('7.3') AND C.FULL_CODE LIKE '%'||CC.CODUL||';%' THEN A.COL1 END) AS COL3
FROM
(SELECT
  D.ANUL,
  D.CUIIO,
