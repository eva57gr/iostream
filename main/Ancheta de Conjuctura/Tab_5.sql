...
SELECT
  ...
  CC.CS_CUATM AS RIND,
--  SUBSTR(A.CAEM2,1,1),
  SUM(CASE WHEN A.RIND IN ('9.01') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL1,
  SUM(CASE WHEN A.RIND IN ('9.02') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL2,
  SUM(CASE WHEN A.RIND IN ('9.03') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL3,
  SUM(CASE WHEN A.RIND IN ('9.04') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL4,
  SUM(CASE WHEN A.RIND IN ('9.05') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL5,
  SUM(CASE WHEN A.RIND IN ('9.06') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL6,
  SUM(CASE WHEN A.RIND IN ('9.07') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL7,
  SUM(CASE WHEN A.RIND IN ('9.08') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL8,
  SUM(CASE WHEN A.RIND IN ('9.09') AND C.FULL_CODE LIKE '%'||CC.CS_CUATM||'%' THEN A.COL1 END) AS COL9
