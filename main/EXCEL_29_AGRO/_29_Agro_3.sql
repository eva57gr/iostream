SELECT *
FROM USER_BANCU.KATALOG_24_2013_PARENT 
;

insert into USER_BANCU.KATALOG_24_2013_PARENT 
...
FROM (
    ...
    SELECT 
        ...
        COALESCE(
            (SELECT MIN(B.CUIIO)
             FROM USER_BANCU.KATALOG_24_2013 B
