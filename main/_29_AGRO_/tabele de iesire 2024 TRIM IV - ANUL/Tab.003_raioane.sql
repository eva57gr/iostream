SELECT
  ...
  ROUND(NVAL(R1110_C2)+NVAL(R1120_C2) + NVAL(R1130_C2) + NVAL(R1130_C2),0) AS COL1,
  ROUND(NVAL(R1110_C3)+NVAL(R1120_C3) + NVAL(R1130_C3) + NVAL(R1130_C3),0) AS COL2,
  ROUND(NVAL(R1110_C4)+NVAL(R1120_C4) + NVAL(R1130_C4) + NVAL(R1130_C4),0) AS COL3
