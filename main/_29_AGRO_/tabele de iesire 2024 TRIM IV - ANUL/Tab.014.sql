...
SELECT
  ...
  SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL5 END) AS COL5,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL3 END))+
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL5 END)) AS COL6
FROM 
  VW_DATA_ALL D
