...
SELECT
  ...
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1300') THEN D.COL5 END)) AS COL5,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' AND D.RIND IN ('1190') THEN D.COL5 END)) AS COL5_1
