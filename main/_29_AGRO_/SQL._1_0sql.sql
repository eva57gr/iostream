...
SUM(CASE WHEN CR.RIND LIKE '%'||D.RIND||'%'  
THEN
CASE  
WHEN CR.RIND IN ('1221') THEN D.COL3 

WHEN CR.RIND BETWEEN '1230' AND  '1239'   THEN D.COL3

WHEN CR.RIND BETWEEN '1301' AND  '1327'   THEN D.COL3

WHEN CR.RIND BETWEEN '1401 ' AND  '1406'   THEN D.COL3

WHEN CR.RIND IN ('1411','1418','1434','1440') THEN D.COL3 

WHEN CR.RIND BETWEEN '1630' AND  '1631'   THEN D.COL3

WHEN CR.RIND BETWEEN '2100' AND  '2302'   THEN D.COL3
