...
SELECT
  ...
  NOZERO(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL2 END)) AS COL6,
  SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL5 END) AS COL7,
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL3 END))+
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL5 END)) AS COL8,
  
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL4 END))+
  NVAL(SUM(CASE WHEN TR.CFOJ LIKE '%'|| D.CFOJ ||'%' AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN D.COL5 END)) AS COL9
...
FROM 
  ...
  CROSS JOIN 
  (
SELECT '500+510+520+530+540+541+560+580+590+620+690+870+880+890+899+684+685' AS CFOJ, 'Intreprinderi agricole si GT (de fermier) cu terenuri agricole de 10 ha si peste' AS CFOJ_DENUMIRE, 1 AS ORDINE FROM DUAL UNION
SELECT '500+510+520+530+540+541+560+580+590+620+690+870+880+890+899' AS CFOJ, 'Intreprindei agricole ' AS CFOJ_DENUMIRE, 2 AS ORDINE FROM DUAL UNION
