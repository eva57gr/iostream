...
SELECT 
  ...
  SUM(CASE WHEN DR.CAPITOL IN (100)  AND DR.RIND IN ('CD')  THEN  DR.COL1 ELSE 0 END)  AS COL1, 
   ...
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('300') THEN  DR.COL1 END) AS COL6,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('300') THEN  DR.COL2 END) AS COL7,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('310') THEN  DR.COL1 END) AS COL8,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('310') THEN  DR.COL2 END) AS COL9,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('320') THEN  DR.COL1 END) AS COL10,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('320') THEN  DR.COL2 END) AS COL11,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('330') THEN  DR.COL1 END) AS COL12,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('330') THEN  DR.COL2 END) AS COL13,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('340') THEN  DR.COL1 END) AS COL14,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('340') THEN  DR.COL2 END) AS COL15,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('350') THEN  DR.COL1 END) AS COL16,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('350') THEN  DR.COL2 END) AS COL17,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('360') THEN  DR.COL1 END) AS COL18,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('360') THEN  DR.COL2 END) AS COL19,
   
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('400') THEN  DR.COL3 END) AS COL20,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('400') THEN  DR.COL4 END) AS COL21,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('400') THEN  DR.COL5 END) AS COL22,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('500') THEN  DR.COL8 END) AS COL23,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('500') THEN  DR.COL9 END) AS COL24,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('500') THEN  DR.COL10 END) AS COL25,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('510') THEN  DR.COL8 END) AS COL26,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('510') THEN  DR.COL9 END) AS COL27,
   SUM(DISTINCT CASE WHEN DD.COL4 BETWEEN 0 AND 249 AND DR.RIND IN ('510') THEN  DR.COL10 END) AS COL28
