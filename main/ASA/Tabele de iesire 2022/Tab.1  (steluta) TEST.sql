...
--CC.CLMN,
 ...
 CASE WHEN RR.NR_ROW NOT IN ('04') THEN 
         ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 IS NULL)  THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   ...
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) 
 ELSE
          ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO)  THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) END AS COL1,
 ----
 CASE WHEN RR.NR_ROW NOT IN ('04') THEN 
         ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 IS NULL) AND DD.CFP IN ('11','12','13')   THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) 
 ELSE
          ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO) AND DD.CFP IN ('11','12','13') THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) END AS COL2,

---
 ----
 CASE WHEN RR.NR_ROW NOT IN ('04') THEN 
         ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 IS NULL) AND DD.CFP IN ('14','15','16','17','18','19')    THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) 
 ELSE
          ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO) AND DD.CFP IN ('14','15','16','17','18','19')  THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) END AS COL3,         
 ----
 CASE WHEN RR.NR_ROW NOT IN ('04') THEN 
         ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 IS NULL) AND DD.CFP IN ('20','21')    THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) 
 ELSE
          ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO) AND DD.CFP IN ('20')  THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) END AS COL4,  
                   
  ----
 CASE WHEN RR.NR_ROW NOT IN ('04') THEN 
         ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 IS NULL) AND DD.CFP IN ('22','23','24','25','26','27')   THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) 
 ELSE
          ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO) AND DD.CFP IN ('22','23','24','25','26','27')  THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) END AS COL5,         
---          
    
 CASE WHEN RR.NR_ROW NOT IN ('04') THEN 
         ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO OR DD.COL4 IS NULL) AND DD.CFP IN ('28')   THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) 
 ELSE
          ROUND(SUM(CASE WHEN (DD.COL4 BETWEEN RR.PERS_FROM AND RR.PERS_TO) AND DD.CFP IN ('28')  THEN ROUND
             (CASE WHEN  D.CAPITOL IN (1124, 1125)       THEN DECODE(CC.NR_COLUMN, '1', D.COL1) 
                   WHEN  D.CAPITOL IN (1126)              THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)
                   WHEN  D.CAPITOL IN (1127)              THEN DECODE(CC.NR_COLUMN, '1', D.COL3, '2', D.COL4, '3', D.COL5)
                   WHEN  D.CAPITOL IN (1128)              THEN DECODE(CC.NR_COLUMN, '1', D.COL8, '2', D.COL9, '3', D.COL10) END,11) END),0) END AS COL6    
---          
...
-------------------------------------------------------------------------------
SELECT 
DISTINCT D.CUIIO,D.CUIIO_VERS,D. CUATM, CASE WHEN D.CFP_AJUSTAT IS NULL THEN D.CFP ELSE D.CFP_AJUSTAT END AS CFP,
D.COL4, D.CD
 FROM (
SELECT 
...
WHERE
  ...
  D.PERIOADA =:pPERIOADA AND
  D.CUATM_FULL LIKE '%'||:pCOD_CUATM||';%'   AND
  D.CAPITOL IN (1127,100,1129) AND
  D.RIND IN ('400', 'CD','5')
...
)D)DD ON D.CUIIO=DD.CUIIO AND D.CUIIO_VERS=DD.CUIIO_VERS
...
SELECT 
 ...
 CASE WHEN RR.NR_ROW NOT IN ('04') THEN
  ROUND(SUM( CASE WHEN (D.PERS BETWEEN RR.PERS_FROM AND RR.PERS_TO OR D.PERS IS NULL) AND D.CFP IN  ('20','21') THEN ROUND(DECODE(R.NR_ROW, 
   '600',D.COL1,
   '700',D.COL2),2) END),1)   
  ELSE
  ROUND(SUM( CASE WHEN (D.PERS BETWEEN RR.PERS_FROM AND RR.PERS_TO)AND D.CFP IN  ('20','21') THEN ROUND(DECODE(R.NR_ROW, 
   '600',D.COL1,
