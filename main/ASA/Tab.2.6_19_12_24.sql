...
SUM( CASE WHEN (DD.PERS BETWEEN 10 AND 19  ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL3,
SUM( CASE WHEN (DD.PERS BETWEEN 20 AND 49  ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL4,
...
SUM( CASE WHEN (DD.PERS BETWEEN 50 AND 99  ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL6,
SUM( CASE WHEN (DD.PERS BETWEEN 100 AND 249  ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX)  THEN COL0 ELSE 0 END ) AS COL7,
SUM( CASE WHEN (DD.PERS BETWEEN 50 AND 249  ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL8,
SUM( CASE WHEN (DD.PERS BETWEEN 250 AND 9999999  ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL9,
SUM( CASE WHEN (DD.PERS BETWEEN 250 AND 499  )  AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL10,
SUM( CASE WHEN (DD.PERS BETWEEN 499 AND 9999999  ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX)  THEN COL0 ELSE 0 END ) AS COL11
