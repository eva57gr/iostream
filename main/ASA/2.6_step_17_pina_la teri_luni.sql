...
CR.ORDINE, 
CR.NR_ROW,   
SUM(CASE WHEN  (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX)  THEN DD.COL0 ELSE 0 END ) AS COL1,
SUM( CASE WHEN (DD.PERS BETWEEN 0 AND 9 OR DD.PERS IS NULL ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX)   THEN COL0 ELSE 0 END ) AS COL2,
SUM( CASE WHEN (DD.PERS BETWEEN 10 AND 19 OR DD.PERS IS NULL ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL3,
SUM( CASE WHEN (DD.PERS BETWEEN 20 AND 49 OR DD.PERS IS NULL ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL4,
SUM( CASE WHEN (DD.PERS BETWEEN 0 AND 49 OR DD.PERS IS NULL ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL5,
SUM( CASE WHEN (DD.PERS BETWEEN 50 AND 99 OR DD.PERS IS NULL ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL6,
SUM( CASE WHEN (DD.PERS BETWEEN 100 AND 249 OR DD.PERS IS NULL ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX)  THEN COL0 ELSE 0 END ) AS COL7,
SUM( CASE WHEN (DD.PERS BETWEEN 50 AND 249 OR DD.PERS IS NULL ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL8,
SUM( CASE WHEN (DD.PERS BETWEEN 250 AND 9999999 OR DD.PERS IS NULL ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL9,
SUM( CASE WHEN (DD.PERS BETWEEN 250 AND 499 OR DD.PERS IS NULL )  AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL10,
SUM( CASE WHEN (DD.PERS BETWEEN 499 AND 9999999 OR DD.PERS IS NULL ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX)  THEN COL0 ELSE 0 END ) AS COL11
...
--  
 ...
 CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN (100)  AND D.RIND IN ('1','5') THEN  D.COL1 ELSE 0 END)) > 0 ) DD
  ...
  CROSS JOIN (
  SELECT 1 ORDINE, 'Total'  NR_ROW,  0 AS MIN, 999999999 AS MAX  FROM DUAL UNION   
SELECT 2 ORDINE, 'au activat pina la 3 luni' NR_ROW,  0 AS MIN, 3 AS MAX  FROM DUAL UNION
SELECT 3 ORDINE, 'au activat de la 3 pina la 6 luni'  NR_ROW,  3 AS MIN, 6 AS MAX  FROM DUAL UNION
SELECT 4 ORDINE, 'au activat de la 6 pina la 9 luni'  NR_ROW,  6 AS MIN, 9 AS MAX  FROM DUAL UNION
SELECT 5 ORDINE, 'au activat de la 9 pina la 12 luni' NR_ROW,  9 AS MIN, 12 AS MAX  FROM DUAL ) CR
