...
SUM( CASE WHEN (DD.PERS BETWEEN 0 AND 9  ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX)   THEN COL0 ELSE 0 END ) AS COL2,
...
SUM( CASE WHEN (DD.PERS BETWEEN 0 AND 49  ) AND (DD.COL0  BETWEEN  CR.MIN  AND  CR.MAX) THEN COL0 ELSE 0 END ) AS COL5,
