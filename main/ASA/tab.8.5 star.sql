...
ROUND(CIS2.NVAL(SUM(D.CD)),2)  AS COL1, 
 
 ROUND(CIS2.NVAL(SUM(D.COL2)),2)  AS COL2,
 ROUND(CIS2.NVAL(SUM(D.COL3)),3)  AS COL3,
 ROUND(CIS2.NVAL(SUM(D.COL4)),1)  AS COL4,
 ROUND(CIS2.NVAL(SUM(D.COL5)),1)  AS COL5  
FROM   
   (
...
-- AND  CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN (1127) AND D.RIND IN ('400') THEN  CIS2.NVAL(D.COL4) END))>=0 
