SELECT
  'Descrierea Inovarii trebuie sa con?ina mai mult de 383 de caractere' AS REZULTAT
...
HAVING
 ...
 MAX(CASE WHEN D.CAPITOL||'.'||D.RIND IN ('1048.9.2')  THEN LENGTHC  (D.COL31)      END)  < 383
