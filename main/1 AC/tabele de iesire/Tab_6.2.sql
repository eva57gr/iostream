...
SELECT
  ...
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('02') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('02') THEN D.COL1 ELSE 0 END)))  AS COL3,
  ...
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('03') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('03') THEN D.COL1 ELSE 0 END)))  AS COL6,
  ...
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('04') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('04') THEN D.COL1 ELSE 0 END)))  AS COL9,
  ...
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('06') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('06') THEN D.COL1 ELSE 0 END)))  AS COL12,
--  
  ...
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('07') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('07') THEN D.COL1 ELSE 0 END)))  AS COL15,
  ...
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('08') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('08') THEN D.COL1 ELSE 0 END)))  AS COL18,
 ...
 CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('09') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('09') THEN D.COL1 ELSE 0 END)))  AS COL21,
   ...
   CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('10') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('10') THEN D.COL1 ELSE 0 END)))  AS COL24,
    ...
    CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('11') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('11') THEN D.COL1 ELSE 0 END)))  AS COL27,
  ...
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('12') THEN D.COL2 ELSE 0 END))  / NOZERO(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('12') THEN D.COL1 ELSE 0 END)))  AS COL30                                            
