...
SELECT
  ...
  TO_NUMBER(R.NR_ROW) AS ORDINE,
    '000111111110' AS DECIMAL_POS,
  R.NUME_ROW AS NUME_ROW,
  ROUND(R.COL2,0) AS COL1,ROUND(R.COL3,0) AS COL2, ROUND(R.COL4,0) AS COL3, ROUND(R.COL5,1) AS COL4,
  ROUND(R.COL6,1) AS COL5,ROUND(R.COL7,1) AS COL6, ROUND(R.COL8,1) AS COL7, ROUND(R.COL9,1) AS COL8,
  ROUND(R.COL10,1) AS COL9,ROUND(R.COL11,1) AS COL10, ROUND(R.COL12,1) AS COL11, ROUND(R.COL13,1) AS COL12
FROM
    (
    SELECT 
        D.CS_CUATM AS CUATM,
        ...
        (1000*SUM(R.COL8)/CIS2.NOZERO(ROUND(SUM(R.COL3),0)))/3 AS COL12,
    ...
    FROM
        ...
        FROM
            ...
            SELECT
                  ...
                  DECODE(C.NR_COL,'3',D1.COL3,'4',D1.COL4,'5',D1.COL5,'6',D1.COL6,'7',D1.COL7,'8',D1.COL8,'9',D1.COL9,'10',D1.COL10,'11',D1.COL11,'12',D1.COL12)
                  END) AS COL7,
                  SUM(CASE WHEN D1.RIND IN ('70') AND D1.CAPITOL IN (27) THEN 
                  DECODE(C.NR_COL,'3',D1.COL3,'4',D1.COL4,'5',D1.COL5,'6',D1.COL6,'7',D1.COL7,'8',D1.COL8,'9',D1.COL9,'10',D1.COL10,'11',D1.COL11,'12',D1.COL12)
                  END) AS COL8,
                  CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN D1.RIND IN ('71') AND D1.CAPITOL IN (27) THEN 
                  DECODE(C.NR_COL,'3',D1.COL3,'4',D1.COL4,'5',D1.COL5,'6',D1.COL6,'7',D1.COL7,'8',D1.COL8,'9',D1.COL9,'10',D1.COL10,'11',D1.COL11,'12',D1.COL12)
                  END))) AS COL9,
                  CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN D1.RIND IN ('72') AND D1.CAPITOL IN (27) THEN 
                  DECODE(C.NR_COL,'3',D1.COL3,'4',D1.COL4,'5',D1.COL5,'6',D1.COL6,'7',D1.COL7,'8',D1.COL8,'9',D1.COL9,'10',D1.COL10,'11',D1.COL11,'12',D1.COL12)
                  END))) AS COL10,
                  CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN D1.RIND IN ('73') AND D1.CAPITOL IN (27) THEN 
                  DECODE(C.NR_COL,'3',D1.COL3,'4',D1.COL4,'5',D1.COL5,'6',D1.COL6,'7',D1.COL7,'8',D1.COL8,'9',D1.COL9,'10',D1.COL10,'11',D1.COL11,'12',D1.COL12)
                  END))) AS COL11,
                  SUM(CASE WHEN D1.RIND IN ('120') AND D1.CAPITOL IN (27) THEN 
                  DECODE(C.NR_COL,'3',D1.COL3,'4',D1.COL4,'5',D1.COL5,'6',D1.COL6,'7',D1.COL7,'8',D1.COL8,'9',D1.COL9,'10',D1.COL10,'11',D1.COL11,'12',D1.COL12)
                  END) AS COL12,
                  COUNT (DISTINCT CASE WHEN D.RIND IN ('01','05') AND D.CAPITOL IN (2) AND NVAL(D.COL1)>0 THEN D.CUIIO ELSE NULL END ) AS COL13
              
            FROM CIS2.VW_DATA_ALL D
                  INNER JOIN CIS2.VW_DATA_ALL D1 ON (D.CUIIO = D1.CUIIO AND D.CUIIO_VERS = D1.CUIIO_VERS AND D.FORM = D1.FORM AND D.PERIOADA = D1.PERIOADA AND D.CAPITOL = D1.CAPITOL)
       ...
       --           CIS2.VW_DATA_ALL_COEF D
         --       WHERE
           --       D.PERIOADA IN (:pPERIOADA) AND
            ...
            INNER JOIN CIS2.VW_CL_CAEM2 V ON(V.CODUL LIKE '%'||R.CAEM2||'%')
        ...
        SELECT
              ...
              SUM(CASE WHEN D.RIND IN ('70') AND D.CAPITOL IN (27) THEN D.COL2 END) AS COL8,
              CIS2.NOZERO(
              CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('71') AND D.CAPITOL IN (27) THEN D.COL2 END))
              ) AS COL9,
              CIS2.NOZERO(
              CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('72') AND D.CAPITOL IN (27) THEN D.COL2 END))
              ) AS COL10,
              CIS2.NOZERO(
              CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('73') AND D.CAPITOL IN (27) THEN D.COL2 END))
              ) AS COL11, 
              CIS2.NOZERO(
              CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('120') AND D.CAPITOL IN (27) THEN D.COL2 END)) 
              ) AS COL12,
              COUNT (DISTINCT CASE WHEN D.RIND IN ('01','05') AND D.CAPITOL IN (2) AND NVAL(D.COL1)>0 THEN D.CUIIO ELSE NULL END ) AS COL13
        ...
        FROM CIS2.VW_DATA_ALL D
              INNER JOIN CIS2.VW_CL_CUATM VC ON (D.CUATM = VC.CODUL)
              INNER JOIN CIS2.VW_CL_CAEM2 V ON (D.CAEM2 = V.CODUL)
