...
--  '0' AS NUME_SECTIE2,
  ...
  ROUND(SUM (CASE WHEN D.RIND  IN ('520') AND D.CAPITOL IN (1185)  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 1000,1) AS COL1,
  ROUND((SUM (CASE WHEN D.RIND  IN ('520') AND D.CAPITOL IN (1185)  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN  D.COL1 ELSE 0   END) / 1000)  *
  SUM (CASE WHEN D.RIND  IN ('541') AND D.CAPITOL IN (1185)  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 1000,1) AS COL2,
  
  ROUND((SUM (CASE WHEN D.RIND  IN ('520') AND D.CAPITOL IN (1185)  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 1000)  *
  SUM (CASE WHEN D.RIND  IN ('542') AND D.CAPITOL IN (1185) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 1000,1) AS COL3,
  
   CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('560') AND D.CAPITOL IN (1185) AND   CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL4,
  ROUND(SUM (CASE WHEN D.RIND  IN ('570') AND D.CAPITOL IN (1185)   AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 1000 ,1) AS COL5
