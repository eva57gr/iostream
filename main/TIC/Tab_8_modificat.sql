...
--)
 ...
 CD.CUATM||'~'||CD.NR_ROW  AS NR_ROW,  
  ...
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('511','512') 
  AND D.CAPITOL IN (1185) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL1, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('511') AND D.CAPITOL IN (1185) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL2, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('512') AND D.CAPITOL IN (1185) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL3, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('513') AND D.CAPITOL IN (1185) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL4, 
   ROUND(SUM (CASE WHEN D.RIND  IN ('520') AND D.CAPITOL IN (1185)  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 1000,1) AS COL5,
  ROUND((SUM (CASE WHEN D.RIND  IN ('520') AND D.CAPITOL IN (1185)  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 1000)  *
  SUM (CASE WHEN D.RIND  IN ('531') AND D.CAPITOL IN (1185)  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 100,1) AS COL6,
  
  ROUND((SUM (CASE WHEN D.RIND  IN ('520') AND D.CAPITOL IN (1185)  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 1000)  *
  SUM (CASE WHEN D.RIND  IN ('532') AND D.CAPITOL IN (1185)  AND C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN  D.COL1 ELSE 0   END) / 100,1) AS COL7
