...
--)
  ...
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('410') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL2, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('411') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL3, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('412') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL4, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('413') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL5, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('414') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL6, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('415') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL7, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('416') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL8, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('417') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL9, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('418') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL10, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('419') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL11, 
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('420') AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL12 
