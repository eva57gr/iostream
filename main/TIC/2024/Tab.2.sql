...
--)
 ...
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('150') AND D.CAPITOL IN (1181) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL3, 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('180') AND D.CAPITOL IN (1181) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL4, 
 CIS2.NVAL(SUM ((CASE WHEN D.RIND    IN ('141') AND D.CAPITOL IN (1181) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN  CIS2.NVAL(D.COL1) ELSE 0 END))) AS COL5, 
 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('190') AND D.CAPITOL IN (1181) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL6, 
 CIS2.NVAL(SUM ((CASE WHEN D.RIND    IN ('191') AND D.CAPITOL IN (1181) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN  CIS2.NVAL(D.COL1) ELSE 0 END))) AS COL7,
 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('192') AND D.CAPITOL IN (1181) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL8,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('193') AND D.CAPITOL IN (1181) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL9,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('194') AND D.CAPITOL IN (1181) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL10,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('195') AND D.CAPITOL IN (1181) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL11
