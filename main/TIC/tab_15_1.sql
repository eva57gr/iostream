...
ROUND(SUM(CASE WHEN C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN D.COL1 ELSE 0 END ),1) AS COL1,
ROUND(SUM(CASE WHEN C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN D.COL2 ELSE 0 END ),1) AS COL2,
ROUND(SUM(CASE WHEN C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN D.COL3 ELSE 0 END ),1) AS COL3,
ROUND(SUM(CASE WHEN C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN D.COL4 ELSE 0 END ),0) AS COL4,
ROUND(SUM(CASE WHEN C.FULL_CODE LIKE '%'||CD.CUATM||';%'  THEN D.COL5 ELSE 0 END ),1) AS COL5
