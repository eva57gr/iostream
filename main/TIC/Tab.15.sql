...
--)
 ...
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('930') AND D.CAPITOL IN (1206) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL1, 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('940') AND D.CAPITOL IN (1206) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL2, 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('999') AND D.CAPITOL IN (1206) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) 
