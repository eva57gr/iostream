...
GROUP BY 
    ...
    HAVING
    SUM(CASE WHEN D.COL1 IS NOT NULL AND D.COL1 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL2 IS NOT NULL AND D.COL2 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL3 IS NOT NULL AND D.COL3 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL4 IS NOT NULL AND D.COL4 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL5 IS NOT NULL AND D.COL5 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL6 IS NOT NULL AND D.COL6 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL7 IS NOT NULL AND D.COL7 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL8 IS NOT NULL AND D.COL8 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL9 IS NOT NULL AND D.COL9 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL10 IS NOT NULL AND D.COL10 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL11 IS NOT NULL AND D.COL11 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL12 IS NOT NULL AND D.COL12 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL13 IS NOT NULL AND D.COL13 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL14 IS NOT NULL AND D.COL14 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL15 IS NOT NULL AND D.COL15 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL16 IS NOT NULL AND D.COL16 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL17 IS NOT NULL AND D.COL17 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL18 IS NOT NULL AND D.COL18 != 0 THEN 1 ELSE 0 END) +
    SUM(CASE WHEN D.COL19 IS NOT NULL AND D.COL19 != 0 THEN 1 ELSE 0 END) > 0
