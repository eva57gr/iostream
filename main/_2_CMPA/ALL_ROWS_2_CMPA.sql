SELECT 
         CASE WHEN TO_CHAR(D.PERIOADA) = '1052'  THEN 'TRM I'  
              WHEN TO_CHAR(D.PERIOADA) = '1053'  THEN 'TRM II' 
              WHEN TO_CHAR(D.PERIOADA) = '1054'  THEN 'TRM III'
              WHEN TO_CHAR(D.PERIOADA) = '1055'  THEN 'TRM IV'
