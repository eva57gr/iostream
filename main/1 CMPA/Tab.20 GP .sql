...
SELECT 
        ...
        -- cap.II col1 rind.010 /10000
         ...
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1111') AND D.RIND IN (RR.RIND)  AND D.CUATM_FULL LIKE '%'||1111111||';%'  AND  (D.PERIOADA = :pPERIOADA - 2)  THEN D.COL1 ELSE NULL END))/10000 AS COL1,
         ...
         AND  (D.PERIOADA = :pPERIOADA - 2) THEN D.COL1 ELSE NULL END))/10000 AS COL2,
         ...
         THEN D.COL1 ELSE NULL END))/10000 AS COL3,
         ...
         THEN D.COL1 ELSE NULL END))/10000 AS COL4,
 ...
 ((CIS2.NVAL(SUM(CASE WHEN    (D.PERIOADA = :pPERIOADA - 2)    AND  D.CAPITOL IN ('1111') AND D.RIND IN (RR.RIND)  AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL1 ELSE NULL END))/10000)/
 
 
 
       ((CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN  (D.PERIOADA = :pPERIOADA - 2)     AND   D.CAPITOL IN ('1111') AND D.RIND IN ('100')    AND D.CUATM_FULL LIKE '%'||1111111||';%' THEN D.COL1 ELSE NULL END))/10000))
 ...
 ((CIS2.NVAL(SUM(CASE WHEN    (D.PERIOADA = :pPERIOADA - 2)    AND  D.CAPITOL IN ('1111') AND D.RIND IN (RR.RIND)  AND ((D.CUATM_FULL LIKE '%'||2222222||';%') OR (D.CUATM_FULL LIKE '%0100000;%'))   THEN D.COL1 ELSE NULL END))/10000)/
 
 
 
       ((CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN  (D.PERIOADA = :pPERIOADA - 2)     AND   D.CAPITOL IN ('1111') AND D.RIND IN ('100')    AND ((D.CUATM_FULL LIKE '%'||2222222||';%') OR (D.CUATM_FULL LIKE '%0100000;%'))   THEN D.COL1 ELSE NULL END))/10000))
 ...
 ((CIS2.NVAL(SUM(CASE WHEN    (D.PERIOADA = :pPERIOADA - 2)    AND  D.CAPITOL IN ('1111') AND D.RIND IN (RR.RIND)  AND ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%'))   THEN D.COL1 ELSE NULL END))/10000)/
 
 
 
       ((CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN  (D.PERIOADA = :pPERIOADA - 2)     AND   D.CAPITOL IN ('1111') AND D.RIND IN ('100')    AND ((D.CUATM_FULL LIKE '%'||3333333||';%') OR (D.CUATM_FULL LIKE '%'||9600000||';%'))   THEN D.COL1 ELSE NULL END))/10000))
...
ROUND(
 ...
 ((CIS2.NVAL(SUM(CASE WHEN    (D.PERIOADA = :pPERIOADA - 2)    AND  D.CAPITOL IN ('1111') AND D.RIND IN (RR.RIND)  AND  D.CUATM_FULL LIKE '%'||:pCOD_CUATM||';%'   THEN D.COL1 ELSE NULL END))/10000)/
 
 
 
       ((CIS2.NOZERO(CIS2.NVAL(SUM(CASE WHEN  (D.PERIOADA = :pPERIOADA - 2)     AND   D.CAPITOL IN ('1111') AND D.RIND IN ('100')    AND  D.CUATM_FULL LIKE '%'||:pCOD_CUATM||';%'  THEN D.COL1 ELSE NULL END))/10000))
