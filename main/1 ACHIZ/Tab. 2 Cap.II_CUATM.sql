...
--  '0' AS NUME_SECTIE2,
 ...
 '00000000000' AS DECIMAL_POS, 
  R.NUME_ROW,
  ROUND(SUM(CASE WHEN  CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN  D.COL1 ELSE  NULL END ),2)  AS COL1,
  ROUND(SUM(CASE WHEN  CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%'  THEN  D.COL2 ELSE  NULL END ),2)  AS COL1
