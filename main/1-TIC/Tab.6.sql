...
--  '0' AS NUME_SECTIE2,
  ...
  CIS2.NVAL(COUNT (DISTINCT(CASE WHEN D.RIND  IN ('410','411','412','413','414','415','416','417','418','419','420') 
  AND D.CAPITOL IN (1184) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND  CIS2.NVAL(D.COL1)=1 THEN D.CUIIO END))) AS COL1
