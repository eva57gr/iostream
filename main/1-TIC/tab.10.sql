...
--)
 ...
 SELECT
  ...
  CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('650') AND D.CAPITOL IN (1186) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL1)>0 THEN D.CUIIO END))) AS COL1,
  CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('661','662','663','664','665','666','667','668') AND D.CAPITOL IN (1186) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL1)>0 THEN D.CUIIO END))) AS COL2,
  CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('630') AND D.CAPITOL IN (1186) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL1)>0 THEN D.CUIIO END))) AS COL3,
  CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('640') AND D.CAPITOL IN (1186) AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' AND CIS2.NVAL(D.COL1)>0 THEN D.CUIIO END))) AS COL4 
