...
(
 ...
 SELECT
  ...
  '0001111' AS DECIMAL_POS,
   ...
   ROUND(CIS2.NVAL(SUM(CASE WHEN C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.COL4 ELSE NULL END))/1000,1) AS COL4,
   ROUND(CIS2.NVAL(SUM(CASE WHEN C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.COL5 ELSE NULL END))/1000,1) AS COL5,
   ROUND(CIS2.NVAL(SUM(CASE WHEN C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.COL6 ELSE NULL END))/1000,1) AS COL6,
   ROUND(CIS2.NVAL(SUM(CASE WHEN C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.COL7 ELSE NULL END))/1000,1) AS COL7
