...
SELECT 1181 AS CAPITOL1, 1184 AS CAPITOL2, '130' AS RIND1, '440' AS RIND2, 35 AS ORDINE, '1' AS NR_COLUMN1, NULL AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, '1' AS BOTH_COL, NULL AS CAEM2 FROM DUAL UNION
...
SELECT 1181 AS CAPITOL1, 1185 AS CAPITOL2, '130' AS RIND1, '510' AS RIND2, 39 AS ORDINE, '1' AS NR_COLUMN1, NULL AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, '1' AS BOTH_COL, 'C,D,E,F,G,H,I,J,L,M,N' AS CAEM2 FROM DUAL UNION
SELECT 1181 AS CAPITOL1, 1185 AS CAPITOL2, '510' AS RIND1, '512' AS RIND2, 40 AS ORDINE, '1' AS NR_COLUMN1, NULL AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, '1' AS BOTH_COL, 'C,D,E,F,G,H,I,J,L,M,N' AS CAEM2 FROM DUAL UNION
...
SELECT 1181 AS CAPITOL1, 1187 AS CAPITOL2, '130' AS RIND1, '730' AS RIND2, 64.1 AS ORDINE, '1' AS NR_COLUMN1, NULL AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, '1' AS BOTH_COL, 'C,D,E,F,G,H,I,J,L,M,N' AS CAEM2 FROM DUAL UNION
SELECT 1181 AS CAPITOL1, 1187 AS CAPITOL2, '130' AS RIND1, '740' AS RIND2, 64.2 AS ORDINE, '1' AS NR_COLUMN1, NULL AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, '1' AS BOTH_COL, 'C,D,E,F,G,H,I,J,L,M,N' AS CAEM2 FROM DUAL UNION
SELECT 1181 AS CAPITOL1, 1187 AS CAPITOL2, '130' AS RIND1, '750' AS RIND2, 64.3 AS ORDINE, '1' AS NR_COLUMN1, NULL AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, '1' AS BOTH_COL, 'C,D,E,F,G,H,I,J,L,M,N' AS CAEM2 FROM DUAL UNION
SELECT 1181 AS CAPITOL1, 1187 AS CAPITOL2, '130' AS RIND1, '770' AS RIND2, 64.4 AS ORDINE, '1' AS NR_COLUMN1, NULL AS NR_COLUMN2, '=' AS CONDITIE1, '=' AS CONDITIE2, '1' AS RESULT1, '0' AS RESULT2, '1' AS BOTH_COL, 'C,D,E,F,G,H,I,J,L,M,N' AS CAEM2 FROM DUAL UNION
