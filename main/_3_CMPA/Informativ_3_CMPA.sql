...
SELECT FC.UNIT_CODE,
         ...
         D.UNIT_CODE,
         D.CUATM,
         SUM(CASE WHEN D.CAPITOL IN (1198) AND D.RIND = '6000' THEN D.COL1 ELSE NULL  END) AS COL1,
         SUM(CASE WHEN D.CAPITOL IN (1198) AND D.RIND = '6200' THEN D.COL1 ELSE NULL  END) AS COL2
