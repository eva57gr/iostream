...
SUM(CASE WHEN  C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%'  THEN L.EI_7_8_COL86 ELSE NULL END ) AS EI_7_8_TRIM_2_2022,
SUM(CASE WHEN  C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%'  THEN L.EI_7_8_COL87 ELSE NULL END ) AS EI_7_8_TRIM_2_2022,
SUM(CASE WHEN  C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%'  THEN L.EI_7_8_COL88 ELSE NULL END ) AS EI_7_8_TRIM_2_2022
