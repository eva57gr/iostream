...
SUM(CASE WHEN  C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%'  THEN L.EI_7_8_COL86 ELSE NULL END ) AS TRIM_2_2022,
SUM(CASE WHEN  C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%'  THEN L.EI_7_8_COL87 ELSE NULL END ) AS TRIM_2_2022,
SUM(CASE WHEN  C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%'  THEN L.EI_7_8_COL88 ELSE NULL END ) AS TRIM_2_2022
...
C.FULL_CODE,
 ...
 COUNT (DISTINCT CASE WHEN FC.FORM  = :pFORM THEN  FC.CUIIO END)  AS   EI_7_8_COL86,
...
SELECT C.CODUL,
 ...
 COUNT (DISTINCT CASE WHEN D.FORM  = :pFORM THEN  D.CUIIO END)  AS  EI_7_8_COL87,
 NULL AS EI_7_8_COL88
    ...
    FROM (SELECT DISTINCT D.CUIIO,
           ...
           WHERE D.PERIOADA = :pPERIOADA_TRIM AND D.FORM IN (:pFORM)
...
UNION 
 ...
 NULL AS   EI_7_8_COL86,
 NULL AS   EI_7_8_COL87,
 COUNT (DISTINCT CASE WHEN D.FORM  = :pFORM THEN  D.CUIIO END)  AS  EI_7_8_COL88
