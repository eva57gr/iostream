...
SUM(CASE WHEN  C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%'  THEN L.AM_COL89 ELSE NULL END ) AS AM_2021,
SUM(CASE WHEN  C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%'  THEN L.AM_COL90 ELSE NULL END ) AS AM_2021,
SUM(CASE WHEN  C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%'  THEN L.AM_COL91 ELSE NULL END ) AS AM_2021
...
C.FULL_CODE,
 ...
 COUNT (DISTINCT CASE WHEN FC.FORM  = 42 THEN  FC.CUIIO END)  AS   AM_COL89,
 NULL AS AM_COL90,
 NULL AS AM_COL91
  ...
  SELECT FC.CUIIO,
              ...
              FROM CIS2.FORM_CUIIO  FC
                   ...
                   INNER JOIN (  SELECT CUIIO, MAX (CUIIO_VERS) CUIIO_VERS
                                  ...
                                  WHERE FORM IN (42) AND CUIIO_VERS <= :pPERIOADA_ANUL  
                               GROUP BY CUIIO) BB
                       ON (    BB.CUIIO = FC.CUIIO
                           AND BB.CUIIO_VERS = FC.CUIIO_VERS)
             WHERE FC.FORM IN (42) AND FC.STATUT <> '3'
...
SELECT C.CODUL,
         C.FULL_CODE,
 NULL AS AM_COL89,
 COUNT (DISTINCT CASE WHEN D.FORM  = 42 THEN  D.CUIIO END)  AS  AM_COL90,
 NULL AS AM_COL91
    ...
    FROM (SELECT DISTINCT D.CUIIO,
           ...
           WHERE D.PERIOADA = :pPERIOADA_ANUL AND D.FORM IN (42)
...
UNION 
 ...
 NULL AS   AM_COL89,
 NULL AS   AM_COL90,
 COUNT (DISTINCT CASE WHEN D.FORM  = 42 THEN  D.CUIIO END)  AS  AM_COL91
