...
SELECT 
 TO_NUMBER(CR.NR_ROW) AS ORDINE,
  CR.NUME_ROW AS NR_ROW,
   ...
   CASE WHEN CR.NUME_ROW = 'TOTAL'  
   THEN SUM(CASE WHEN C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%' THEN L.COL4 ELSE NULL END) -1 
   ELSE SUM(CASE WHEN C.FULL_CODE LIKE '%'||CR.CS_CUATM||'%' THEN L.COL4 ELSE NULL END) END  AS ONLY_CIS2
...
CROSS JOIN (
  SELECT
    DECODE(CS.CODUL, 
      '0000000','01',
      '0100000','01.1',
      '0110000','02.1','0120000','02.2','0130000','02.3',
      '0140000','02.4','0150000','02.5',
      '1111111','03','0300000','04',
  ...
  WHERE CS.CODUL IN (
    '0000000', '0100000','0110000','0120000','0130000','0140000','0150000',
    '1111111','0300000','1400000','3400000','3600000','4100000','4300000','4500000',
