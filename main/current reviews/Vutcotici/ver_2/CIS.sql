  ...
  NULL AS COL5
    ...
    FROM (SELECT DISTINCT D.CUIIO,
           ...
           WHERE D.PERIOADA = :pPERIOADA_LUNA AND D.FORM IN (:pFORM)
            ...
            AND D.DATA_REG BETWEEN TO_DATE('03/01/2025 00:00:00', 'MM/DD/YYYY HH24:MI:SS') AND TO_DATE('03/31/2025 23:59:59', 'MM/DD/YYYY HH24:MI:SS')
    ...
    SELECT DISTINCT D.CUIIO,
           ...
           WHERE D.PERIOADA  = :pPERIOADA_LUNA   AND D.FORM IN (:pFORM)
             AND D.ID_SCHEMA = 1
              ...
              AND D.DATA_REG BETWEEN TO_DATE('02/01/2025 00:00:00', 'MM/DD/YYYY HH24:MI:SS') AND TO_DATE('02/31/2025 23:59:59', 'MM/DD/YYYY HH24:MI:SS')
