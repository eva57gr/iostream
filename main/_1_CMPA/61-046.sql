SELECT 
 'Rind. '||D.RIND||': '||
  ...
  CIS2.NVAL(SUM(CASE WHEN D.PERIOADA IN (:PERIOADA-1)  THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)  ELSE NULL END)) ||'<>'|| 
  CIS2.NVAL(SUM(CASE WHEN D.PERIOADA IN (:PERIOADA)    THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)  ELSE NULL END)) 
   AS REZULTAT
