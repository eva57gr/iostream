...
(
  SELECT 
         ...
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND BETWEEN '500' AND '580' AND D.RIND IN (RR.RIND)  THEN D.COL1 ELSE NULL END))/2 AS COL1,
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND BETWEEN '500' AND '580' AND D.RIND IN (RR.RIND)  THEN D.COL4 ELSE NULL END))/2 AS COL2,
         CIS2.NVAL(SUM(CASE WHEN D.CAPITOL IN ('1113') AND D.RIND BETWEEN '500' AND '580' AND D.RIND IN (RR.RIND)  THEN D.COL7 ELSE NULL END))/2 AS COL3,
...
WHERE
 ...
 (D.CUATM_FULL LIKE '%'||:pCOD_CUATM||';%') AND
  D.FORM IN (61)AND  RR.RIND BETWEEN '500' AND '580' AND D.CAPITOL IN ('1113')  
