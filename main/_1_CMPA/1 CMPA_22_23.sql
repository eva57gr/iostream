...
SELECT FC.UNIT_CODE,
         ...
         D.UNIT_CODE,
         D.CUATM,
         SUM(CASE WHEN D.CAPITOL IN (1111) AND D.RIND = '010' THEN D.COL2 ELSE NULL  END) AS RIN_010_COL2,
         SUM(CASE WHEN D.CAPITOL IN (1111) AND D.RIND = '010' THEN D.COL4 ELSE NULL  END) AS RIN_010_COL4
