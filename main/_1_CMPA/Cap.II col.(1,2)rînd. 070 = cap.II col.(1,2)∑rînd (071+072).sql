...
D.NR_GOSP,
  DECODE(CC.NR_COLUMN, '1', 'COL1 ', '2', 'COL2 ')||': '||
   CIS2.NVAL(SUM(CASE WHEN D.RIND  IN('070')         THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)  ELSE NULL END)) ||'<>'||
   CIS2.NVAL(SUM(CASE WHEN D.RIND  IN('071','072')   THEN DECODE(CC.NR_COLUMN, '1', D.COL1, '2', D.COL2)  ELSE NULL END))
